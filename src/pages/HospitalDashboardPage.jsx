...
import { FaTint, FaChartBar, FaPlusCircle, FaExclamationTriangle, FaCheckCircle, FaHourglassHalf, FaShieldAlt, FaUsers, FaBrain } from 'react-icons/fa';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
           ...
           <Card>
               <h2 className="section-title flex items-center gap-2"><FaBrain className="text-primary"/> AI Demand Prediction</h2>
